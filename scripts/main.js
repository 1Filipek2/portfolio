...
const translations = {
  en: {
    about: `Ahoj! Som vývojár zo Slovenska. Moje hlavné oblasti odbornosti sú nízkoúrovňové programovanie, počítačové siete a webový vývoj. Pracujem najmä s jazykmi C, C++, HTML, CSS a PHP, a momentálne si rozširujem znalosti v JavaScripte. Rád vytváram efektívne riešenia, učím sa nové technológie a pracujem s open-source softvérom. Ak sa chceš dozvedieť viac alebo spolupracovať, neváhaj ma kontaktovať!`,
    skills: 'Skills',
